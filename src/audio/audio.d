...
extern(C) {
	__gshared void (*callback)();

	int audio_init(int fr, void (*cb)()) {
...
extern(C) {
	extern char[0x19] sidreg;
	extern int residdelay;
	int sid_init(int, Filterparams*, int, int, int, int, int);
	int sid_fillbuffer(short *, int, int);
	int sid_close();
}
